...
<div class="col-md-12" style="font-size: 11pt;">
  <div class="row">
    <div class="col-md-10 col-sm-9">
      <h3>Edit Order Finishing Belum Selesai</h3>
    </div>
  </div>
  <br>
  <div class="row">
          ...
          <tbody>
              ...
              <tr>
                  ...
                  <td class="project-actions text-center">
                      <a data-toggle="modal" data-target="#ubah_blm<?php echo $row->kode_detail?>" title="Edit" href=""><i class="fas fa-pencil-alt fa-sm"></i></a>&nbsp;
                          <div class="modal fade" id="ubah_blm<?php echo $row->kode_detail?>">
                              <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body"><?php $id = $row->kode_detail?>
                                        <?php echo form_open('grey/greyedit/edit_greystat1/'.$id);?>
                                        <div class="form-row">
