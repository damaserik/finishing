...
<div class="col-md-12" style="font-size: 11pt;">
  <div class="row">
    <div class="col-md-10 col-sm-9">
      <h3>Detail Grey WO</h3>
    </div>
     <div class="col-md-2 col-sm-3">
      <a href="<?php echo site_url('grey/greywo/view_greywo');?>"><button type="button" class="btn btn-dark btn-block">Kembali</button></a>
    </div> 
  </div>
  <br>
  <div class="row">
    ...
    <!--               <td><?php echo $row->proses?></td>
                  ...
                  <td class="project-actions text-center">
                      ...
                      <a title="Edit" href="<?php echo site_url('grey/greywo/edit_greywo/'.$row->kode_detail)?>"><i class="fas fa-pencil-alt fa-sm"></i></a>&nbsp;
                      <a  title="Hapus" href="<?php echo site_url('grey/greywo/hapus_greywodtl/'.$row->kode_detail)?>" onclick="return confirm('Konfirmasi Hapus Data ?')"><i class="fas fa-trash fa-sm"></i></a></td>
              </tr>
              <?php } ?> 
      </table>
    </div>
