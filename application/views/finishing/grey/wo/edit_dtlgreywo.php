			...
			<div class="col-md-10" >
				<div class="card card-outline card-dark">
					<div class="card-header">
						<h3>Form Edit Detail WO</h3>
					</div>
					  <div class="card-body">
							<?php foreach ($ubah_data as $key => $row): ?>			
				        	<form method="POST" action="<?php echo site_url('grey/greywo/greywo_edit/'.$row->kode_detail)?>">
							<div class="form-row">
								<div class="col-md-3">
							...
							<div class="form-row">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input class="form-control form-control-sm" list="kdwo" type="text" name="kode_wo" value="<?php echo $row->kode_wo?>"placeholder="--WO--" autocomplete="off" required="" >
					                    <datalist id="kdwo">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<button type="submit" class="btn btn-primary btn-sm toaster">Simpan</button>
							  		<a href="<?php echo site_url('grey/greywo/view_dtlgreywo/'.$row->kode_ordergry)?>" class="btn btn-secondary btn-sm toaster" onclick="return confirm('Yakin Cancel ?')">Batal</a>
									</div>
								</div>
							</div>
							</form>
