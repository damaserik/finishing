...
<div class="container col-md-9">
	<div class="card card-outline card-dark">
		...
		<h3>Form Input Grey WO</h3>
		</div>
	<div class="card bg-light">
	  <div class="card-body">		
			<?php echo validation_errors();?>
			<?php echo form_open('grey/greywo/simpan_greywo/');?>
			<div class="form-row">
			    ...
			    <div class="form-group col-md-3">
				    ...
				    <select class="form-control form-control-sm" name="kode_group" required="">
						<option selected value="G0002">WO</option>
					</select>
			    </div>		
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group float-right">
						...
						<a href="<?php echo site_url('grey/greywo/view_greywo');?>" class="btn btn-secondary btn-sm" onclick="return confirm('Yakin Cancel ?')">Batal</a>
					</div>
				</div>
			</div>
			<br>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		+		"<div class='form-group col-md-3'>"
		+		    "<label>Kode WO</label>"
		+			"<input class='form-control form-control-sm' list='kdwo' type='text' name='kode_wo[]' placeholder='--WO--' autocomplete='off' required='' >"
        +             "<datalist id='kdwo'>"
