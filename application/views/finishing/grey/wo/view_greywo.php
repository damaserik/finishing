...
<div class="col-md-12" style="font-size: 11pt;">
  <div class="row">
    <div class="col-md-10 col-sm-9">
      <h3>Penerimaan Grey WO</h3>
    </div>
    <div class="col-md-2 col-sm-3">
      <a href="<?php echo site_url('grey/greywo/tambah_greywo');?>"><button type="button" class="btn btn-dark btn-block">Tambah</button></a>
    </div>
  </div>
  <br>
  <div class="row">
          ...
          <tbody>
              ...
              <tr>
                  ...
                  <td class="project-actions text-center">
                      ...
                      <a  title="Detail Order" href="<?php echo site_url('grey/greywo/view_dtlgreywo/'.$row->kode_ordergry)?>"><i class="fas fa-align-justify fa-sm"></i></a>&nbsp; 
                      <a data-toggle="modal" data-target="#ubah_grywo<?php echo $row->kode_ordergry?>" title="Edit Order" href=""><i class="fas fa-pencil-alt fa-sm"></i></a>&nbsp;
                      <a  title="Hapus" href="<?php echo site_url('grey/greywo/hapus_greywo/'.$row->kode_ordergry)?>" onclick="return confirm('Konfirmasi Hapus Data ?')"><i class="fas fa-trash fa-sm"></i></a>&nbsp;
                      <!-- <a title="Edit Selesai" href="<?php echo site_url('#'.$row->no_ordergry)?>"><i class="fas fa-edit"></i></a> -->

                      <div class="modal fade" id="ubah_grywo<?php echo $row->kode_ordergry?>">
                              <div class="modal-dialog  modal-sm">
                                ...
                                <?php echo form_open('grey/greywo/view_gryhdr/'.$id);?>
                                <div class="col-md-12">
