...
<div class="container col-md-8">
	<div class="card card-outline card-dark">
		  ...
		  <div class="card-body">		
				...
				<div class="form-row">
				    ...
				    <div class="form-group col-md-3">
					    ...
					    <div class='input-group-prepend'>
	                		<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-cfoldpp">Cari</button>
	                		<input type="text" class="form-control form-control-sm" name="no_orderppcmb" id="no_pp" readonly="">
	                	</div>
				    </div>
				    <div class="form-group col-md-3">
					    <label>Tanggal</label>
					    <input class="form-control form-control form-control-sm" type="date" name="tgl_packing" required="" autocomplete="off" value="<?php echo date('Y-m-d');?>">
				    </div>		
				    <div class="form-group col-md-2" hidden="">
					    <label>Kode Packing</label>
					    <input type="text" class="form-control form-control-sm" name="kode_packing_trans" value="2" autofocus autocomplete="off">
				    </div>					
				    <div class="form-group col-md-3">
				...
				<div class="form-row">
					<div class="form-group col-md-2">
					    <label>Nomor</label>
					    <input type="number" class="form-control form-control-sm" name="no_gulpack" step=any min="0">
				    </div>
					<div class="form-group col-md-2">
					    <label>Gulung</label>
					    <input type="number" class="form-control form-control-sm" name="gulung_packing" step=any min="0">
				    </div>
					<div class="form-group col-md-2">
					    <label>Packing</label>
					    <input type="number" class="form-control form-control-sm" name="packing" step=any min="0">
				    </div>
				</div>
				...
				<div class="form-group col-md-2">
				<form class="form-inline" method="POST" action="<?php echo site_url('cambric/campacking/view_packingtgl/');?>">
		...
		<!-- ============================================== MODAL CARI DATA PP =========================================== -->
			<div class="modal" id="modal-cfoldpp">
			    <div class="modal-dialog modal-lg">
			      <div class="modal-content">
			        ...
			        <div class="modal-body">
			        	<table id="cfoldpp" class="table table-sm table-bordered table-responsive-md table-hover dataTable" role="grid">
			        		<thead>
			        			<tr>
				        			<th>No PP</th>
				        			<th>Tgl PP</th>
			        		...
			        		<tbody>
			        		<?php foreach ($get_foldpp as $i) { ?>
			        			<tr id="pilih_foldpp"
									kode_cdetail ="<?php echo $i->kode_dtl_folding?>"
									no_corderppcmb ="<?php echo $i->no_orderppcmb?>"
									tgl_cpp ="<?php echo $i->tgl_folding?>"
...
$(document).ready(function(){
		...
		$(document).on('click', '#pilih_foldpp', function (e) {
